...
const splitCallArguments = root.splitCallArguments;
const splitTopLevelCommaExpressions = root.splitTopLevelCommaExpressions;
const splitTypeArguments = root.splitTypeArguments;
const convertApexType = root.convertApexType;
const collectionKindFromName = root.collectionKindFromName;
const normalizeSoqlQueryForEmulation = root.normalizeSoqlQueryForEmulation;
const convertBindReferenceToJava = root.convertBindReferenceToJava;
const isSoqlBindNameChar = root.isSoqlBindNameChar;
...
const isSimpleBindReference = root.isSimpleBindReference;
const convertApexTypeList = root.convertApexTypeList;
const normalizeScalarTypeName = root.normalizeScalarTypeName;
const buildDatabaseQueryCall = root.buildDatabaseQueryCall;
const rewriteTokenOverloadCalls = root.rewriteTokenOverloadCalls;
const collectionImplName = root.collectionImplName;
const convertApexExpressionToJava = root.convertApexExpressionToJava;
